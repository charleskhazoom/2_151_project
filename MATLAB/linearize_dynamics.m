...
% linearize_dynamics: returns linearized system and input weighting
% matrices about given equilibrium state and inputs
%
% INPUTS
...
% B_lin: linearized input weighting matrix
    ...
    for i = 1:n_states
        ...
        dz_dev = dynamics(t, z_dev, u_equi, p); % rate of change of state from this position
    ...
    for i = 1:n_inputs
        ...
        dz_dev = dynamics(t, z_equi, u_dev, p); % rate of change of state from this input
