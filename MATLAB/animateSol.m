function animateSol(tspan, x, p, ballX, rEE, theta, start_pos, final_pos, keep_frames, videoName, save_video)
...
% videoName: name to save animated solution video as MP4
% save_video: boolean about saving video
